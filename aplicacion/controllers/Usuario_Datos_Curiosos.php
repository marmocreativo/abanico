...
class Usuario_Datos_Curiosos extends CI_Controller {
...
$this->lang->load('front_end', $_SESSION['lenguaje']['iso']);
		...
		if($this->agent->is_mobile()){
			...
			$this->load->model('DatosCuriososModel');
	...
	public function index()
	{
		if(!verificar_sesion($this->data['op']['tiempo_inactividad_sesion'])){
			...
			$this->data['datos_curiosos'] = $this->DatosCuriososModel->lista('',$_SESSION['usuario']['id'],'','');
			$this->load->view($this->data['dispositivo'].'/usuarios/headers/header',$this->data);
			$this->load->view($this->data['dispositivo'].'/usuarios/lista_datos_curiosos',$this->data);
