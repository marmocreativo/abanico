...
class Admin_CortePlanes extends CI_Controller {
...
$this->lang->load('front_end', $_SESSION['lenguaje']['iso']);
	...
	public function index()
	{
			...
			$this->load->view($this->data['dispositivo'].'/admin/lista_corte_planes',$this->data);
	...
	public function imprimir()
	{
			...
			$this->load->view($this->data['dispositivo'].'/admin/lista_corte_planes_imprimir',$this->data);
