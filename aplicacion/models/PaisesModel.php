 ...
 */
  function detalles($id){
    return $this->db->get_where('paises',array('ID_PAIS'=>$id))->row_array();
  }
  /*
    * Creo una nueva entrada usando los parámetros
 */
  function crear($parametros){
    $this->db->insert('paises',$parametros);
 ...
 */
  function actualizar($id,$parametros){
    ...
    return $this->db->update('paises',$parametros);
  }
  /*
    * Borro una entrada
    * $id es el identificador de la entrada
 */
  function borrar($id){
    return $this->db->delete('paises',array('ID_PAIS'=>$id));
  }
  /*
 ...
 */
  function activar($id,$activo){
    ...
    $this->db->where('ID_PAIS',$id);
    return $this->db->update('paises',array('PAIS_ESTADO'=>$activo));
  }
  /*
