<?php
class CarruselesModel extends CI_Model {
 ...
 */
  function detalles($id){
    return $this->db->get_where('carruseles',array('ID'=>$id))->row_array();
  }
  /*
    * Creo una nueva entrada usando los parámetros
 */
  function crear($parametros){
    $this->db->insert('carruseles',$parametros);
 ...
 */
  function actualizar($id,$parametros){
    $this->db->where('ID',$id);
    return $this->db->update('carruseles',$parametros);
  }
  /*
    * Borro una entrada
    * $id es el identificador de la entrada
 */
  function borrar($id){
    return $this->db->delete('carruseles',array('ID'=>$id));
  }
  /*
 ...
 */
  function activar($id,$activo){
    ...
    $this->db->where('ID',$id);
    return $this->db->update('carruseles',array('ESTADO'=>$activo));
  }
 ...
 */
  function ordenar($orden){
    ...
    foreach($orden as $orden){
      ...
      return $this->db->update('carruseles',array('ORDEN'=>$i));
      ++$i;
    }
  }
