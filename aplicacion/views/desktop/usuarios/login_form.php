        ...
        <div class="col-12 col-sm-5">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php } ?>
              <hr>
                <form class="" action="<?php echo base_url('usuario/iniciar_sesion');?>" method="post">
            ...
            <div class="card-footer">
              <nav class="nav justify-content-center nav-fill">
                <!--<a class="nav-link" href="<?php echo base_url('usuario/olvide_pass');?>"> <span class="fa fa-question-circle"></span> Olvide mi contraseña</a>-->
                <a class="nav-link" href="<?php echo base_url('usuario/registro_form');?>"> <span class="fa fa-pen-square"></span> Registrarme</a>
              </nav>
            </div>
          </div>
        </div>
