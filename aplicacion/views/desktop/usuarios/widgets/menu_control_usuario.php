...
<div class="list-group" id="menu-usuario">
  <a href="<?php echo base_url('usuario/');?>" class="btn btn-outline-primary-12 btn-block"> <i class="fa fa-tachometer-alt"></i> <p class="mb-0"><?php echo $this->lang->line('usuario_menu_escritorio'); ?></p></a>
  <a href="<?php echo base_url('usuario/pedidos');?>" class="btn btn-outline-primary-7 btn-block"> <i class="fa fa-shopping-bag"></i> <p class="mb-0"><?php echo $this->lang->line('usuario_menu_pedidos'); ?></p></a>
