                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <?php foreach ($mensajes as $mensaje) { ?>
                        <li class="media border-bottom p-3 mb-3">
                            <img class="mr-3" src="<?php echo base_url('assets/global/img/usuario_default.png'); ?>" width="20" alt="Usuario">
                            <div class="media-body">
                            <h6 class="mt-0 mb-1"><?php echo $mensaje->USUARIO_NOMBRE.' '.$mensaje->USUARIO_APELLIDOS ?></h6>
                            <p><?php echo $mensaje->MENSAJE_TEXTO; ?></p>
                        </li>
                    <?php  } ?>
                    </ul>
                    </div>
