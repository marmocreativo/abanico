          ...
          <div class="card">
            <div class="card-header d-flex justify-content-between">
              ...
              <div class="herramientas">
                  <a href="<?php echo base_url('usuario/servicios'); ?>" class="btn btn-sm btn-outline-success"> <span class="fa fa-arrow-left"></span> Regresar a los servicios</a>
              </div>
            </div>
            <div class="card-body">
              <div class="row">
                      ...
                      <div class="row">
                        <div class="col">
                          <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" id="galeria-tab" data-toggle="tab" href="#galeria" role="tab" aria-controls="galeria" aria-selected="true"> <span class="fa fa-images"></span> Galeria</a>
                            </li>
                          </ul>
