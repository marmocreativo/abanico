                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group float-right">
                        ...
                        <button data-enlace='<?php echo base_url('usuario/direcciones/borrar?id='.$direccion->ID_DIRECCION); ?>' class="btn btn-sm btn-danger borrar_entrada" title="Eliminar Dirección"> <span class="fa fa-ban"></span> </button>
                      </div>
                    </td>
                  </tr>
                <?php } ?>
