        ...
        <?php }else{?>
          <div class="card <?php echo 'border'.$primary; ?>">
            <div class="card-body">
              ...
              <hr>
              <a href="<?php echo base_url('admin/planes/lista_planes?tipo=servicios&id_usuario='.$_GET['id_usuario']); ?>" class="btn btn-primary"> <i class="fa fa-plus"></i> Activar Plan</a>
            </div>
          </div>
        <?php } ?>
    </div>
