            ...
            <tr>
              ...
              <td class="text-right">
                <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  <button type="button" class="btn btn-danger borrar_entrada" data-enlace="<?php echo base_url('admin/divisas/borrar')."?id=".$divisa->ID_DIVISA; ?>" title="Eliminar Divisa"><span class="fa fa-trash"></span></button>
                </div>
              </td>
            </tr>
            <?php } ?>
