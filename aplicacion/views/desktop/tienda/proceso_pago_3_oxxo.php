          ...
          <div class="card-body">
            ...
            <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="head2" style="font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: 600; text-align: center; border-top: 1px solid lightgray;background-image: url('<?php echo base_url('assets/global/img/pleca_mail_2.png'); ?>'); backgroun-repeat:no-repeat;">
                                      <h4 style="margin:0;color:#495057;"><strong>La referencia de pago llegará a tu correo electrónico</strong></h4>
                                    </td>
                                </tr>
                              </tbody>
                            </table>
                            ...
                            <tbody>
                              <tr>
                                <td colspan="1" style="vertical-align:middle; font-size:16px;">
                                  <img src="<?php echo base_url('assets/global/img/oxxo.png'); ?>" style="float:left; margin-right:15px;" width="100%" alt="">
                                </td>
                                ...
                                <td colspan="2" style="vertical-align:middle; font-size:16px; border-left:solid 1px lightgrey">
                                  <form class="d-flex justify-content-end" action="<?php echo base_url('proceso_pago_4?pago=oxxo'); ?>" method="post">
                                    <input type="hidden" name="FormaPago" value='OXXO'>
              ...
              $_SESSION['pedido'] = array();
                ...
                $_SESSION['pedido']['FormaPago'] = 'OXXO';
