 ...
 */
  ...
  */
  jQuery( document ).ready(function( $ ) {
    if ( jQuery( "#reloj" ).length ) {

      var hora_fin = jQuery("#reloj").attr('data-hora-fin');

      var countDownDate = new Date(hora_fin).getTime();
      ...
      var x = setInterval(function() {
        ...
        document.getElementById("reloj").innerHTML =  '<span class="badge badge-primary-10" id="reloj_horas">Oferta <i class="fas fa-bolt"></i></span> <span class="badge badge-primary-10" id="reloj_horas">'+hours+' h</span> : <span class="badge badge-primary-10" id="reloj_minutos">'+minutes+' m</span> : <span class="badge badge-primary-10" id="reloj_segundos">'+seconds+' s</span>';

        // If the count down is finished, write some text

        if (distance < 0) {
          clearInterval(x);
          document.getElementById("reloj").innerHTML = "Promoción terminada";
          document.getElementById("contenedor-botones-compra").classList.add("d-none");
        }
