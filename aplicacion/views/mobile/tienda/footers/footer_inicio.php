  ...
  <div class="container-fluid">
    <div class="row p-3">
      <div class="col-12">
        ...
        <?php $publicaciones_acerca = $this->PublicacionesModel->lista(['PUBLICACION_TIPO'=>'acerca','PUBLICACION_ESTADO'=>'activo'],'','');?>
      ...
      <div class="col-12 mt-3 bordered-top">
        <h5>Concursos</h5>
        <?php $publicaciones_acerca = $this->PublicacionesModel->lista(['PUBLICACION_TIPO'=>'concursos','PUBLICACION_ESTADO'=>'activo']],'','');?>
        <ul class="list-unstyled">
          <?php foreach($publicaciones_acerca as $publicacion){ ?>
          <li> <a href="<?php if(empty($publicacion->PUBLICACION_URL_EXTERNA)){ echo base_url('publicacion/'.$publicacion->PUBLICACION_URL); }else{ echo $publicacion->PUBLICACION_URL_EXTERNA; } ; ?>"><?php echo $publicacion->PUBLICACION_TITULO; ?></a> </li>
          <?php } ?>
      ...
      <div class="col-12 mt-3 bordered-top">
        <h5>Ayuda</h5>
        <?php $publicaciones_acerca = $this->PublicacionesModel->lista(['PUBLICACION_TIPO'=>'ayuda','PUBLICACION_ESTADO'=>'activo']],'','');?>
        <ul class="list-unstyled">
          <?php foreach($publicaciones_acerca as $publicacion){ ?>
          <li> <a href="<?php if(empty($publicacion->PUBLICACION_URL_EXTERNA)){ echo base_url('publicacion/'.$publicacion->PUBLICACION_URL); }else{ echo $publicacion->PUBLICACION_URL_EXTERNA; } ; ?>"><?php echo $publicacion->PUBLICACION_TITULO; ?></a> </li>
          <?php } ?>
      ...
      <div class="col-12 mt-3 bordered-top">
        <h5>Legales</h5>
        <?php $publicaciones_acerca = $this->PublicacionesModel->lista(['PUBLICACION_TIPO'=>'legales','PUBLICACION_ESTADO'=>'activo']],'','');?>
        <ul class="list-unstyled">
          <?php foreach($publicaciones_acerca as $publicacion){ ?>
          <li> <a href="<?php if(empty($publicacion->PUBLICACION_URL_EXTERNA)){ echo base_url('publicacion/'.$publicacion->PUBLICACION_URL); }else{ echo $publicacion->PUBLICACION_URL_EXTERNA; } ; ?>"><?php echo $publicacion->PUBLICACION_TITULO; ?></a> </li>
          <?php } ?>
