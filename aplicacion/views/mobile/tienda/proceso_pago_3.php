                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                          <?php /* BUCLE DE PRODUCTOS*/ foreach($_SESSION['carrito']['productos'] as $producto){ ?>
                            ...
                            <tr>
                              <td>
                                    <img src="<?php echo $producto['imagen_producto'];  ?>" class="img-thumbnail" width="70px" alt="">
                                    <br>
                                    <a href="#" class="h6"><?php echo $producto['nombre_producto'];  ?></a>
                                    <p style="font-size:0.8em;" class="mb-1">(x<?php echo $producto['cantidad_producto'];  ?>)</p>
                      ...
                      <?php if(!empty($envio_abanico)){ ?>
                        ...
                        <?php foreach ($envio_abanico as $rangos) { ?>
                          <div class="form-check">
                            ...
                            <?php echo $rangos->TRANSPORTISTA_NOMBRE;  ?> <br> <?php echo $rangos->TRANSPORTISTA_TIEMPO_ENTREGA;  ?> <br> $<?php if($solo_productos_envio_gratuito&&$transportista_gratuito==$rangos->ID_TRANSPORTISTA){ echo '0.00 <small>Promoción Envío gratuito</small>'; }else{ echo ($_SESSION['divisa']['conversion']*$rangos->IMPORTE); }  ?></label>
                          </div>
                          ...
                          <?php /* BUCLE DE PRODUCTOS*/ foreach($_SESSION['carrito']['productos'] as $producto){ ?>
                            ...
                            <tr>
                              <td>
                                    ...
                                    <a href="#" class="h6"><?php echo $producto['nombre_producto'];  ?></a>
                                    <p style="font-size:0.8em;" class="mb-1">(x<?php echo $producto['cantidad_producto'];  ?>)</a></p>
                                    <p style="font-size:0.8em;" class="mb-1">Vendido por: <a href="#"><?php echo $producto['nombre_tienda'];  ?></a></p>
                                    <p style="font-size:0.8em;" class="mb-1"><?php echo $producto['detalles_producto'];  ?></p>
                                    <p style="font-size:0.8em;" class="mb-1"><?php $peso = $producto['cantidad_producto']*$producto['peso_producto']; echo $producto['peso_producto'];  ?>kg</p>
                                    <?php if($producto['contra_entrega']=='si' && $detalles_direccion['DIRECCION_PAIS']=='Estados Unidos'){ ?>
                            ...
                            <div class="border p-3">
                              ...
                              <?php foreach ($envio_tiendas as $rangos) { ?>
                                <div class="form-check">
                                  ...
                                  <?php echo $rangos->TRANSPORTISTA_NOMBRE;  ?> <br> <?php echo $rangos->TRANSPORTISTA_TIEMPO_ENTREGA;  ?> <br> $<?php echo $_SESSION['divisa']['conversion']*$rangos->IMPORTE;  ?> </label>
                                </div>
