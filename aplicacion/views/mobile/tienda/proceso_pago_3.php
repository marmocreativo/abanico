                      ...
                      <?php if(!empty($envio_abanico)){ ?>
                        ...
                        <?php foreach ($envio_abanico as $rangos) { ?>
                          <div class="form-check">
                            ...
                            <?php echo $rangos->TRANSPORTISTA_NOMBRE;  ?> <br> <?php echo $rangos->TRANSPORTISTA_TIEMPO_ENTREGA;  ?> <br> $<?php echo ($_SESSION['divisa']['conversion']*$rangos->IMPORTE);  ?> <?php echo $_SESSION['divisa']['iso']; ?></label>
                          </div>
