  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
            <form class="" action="http://localhost/abanico-master/usuario/actualizar" method="post">
              <input type="hidden" name="TipoUsuario" value="usr-1">
              <div class="row">
                <div class="col-12">
                  <h3 class="h5">Datos Requeridos</h3>
                   <div class="form-group">
                     <label for="NombreUsuario">Nombre</label>
                     <input type="text" class="form-control form-control-sm" id="NombreUsuario" name="NombreUsuario" placeholder="" value="fernando">
                   </div>
                   <div class="form-group">
                     <label for="ApellidosUsuario">Apellidos</label>
                     <input type="text" class="form-control form-control-sm" id="ApellidosUsuario" name="ApellidosUsuario" placeholder="" value="gutierrez">
                   </div>
                   <div class="form-group">
                     <label for="CorreoUsuario">Correo electrónico</label>
                     <input type="email" class="form-control form-control-sm" id="CorreoUsuario" name="CorreoUsuario" placeholder="" value="fernando@email.com">
                   ...
                   <div class="form-group">
                     ...
                     <input type="text" class="form-control form-control-sm" id="TelefonoUsuario" name="TelefonoUsuario" placeholder="" value=" ">
                   ...
                   <div class="form-group">
                     ...
                     <input type="date" class="form-control form-control-sm" id="FechaNacimientoUsuario" name="FechaNacimientoUsuario" placeholder="" value="0000-00-00">
                   </div>
                   <hr>
                   <div class="custom-control custom-checkbox my-1 mr-sm-2">
                     <input type="checkbox" class="custom-control-input" id="ListaDeCorreoUsuario" name="ListaDeCorreoUsuario" checked="">
            ...
            <hr>
            <button type="submit" class="btn btn-sm btn-primary float-right" name="button"> <span class="fa fa-save"></span> Guardar</button>
          </form>
        </div>
      </div>
    ...
    <div class="col-12">
      ...
      <div class="card border-primary text-center mb-3">
        ...
        <div class="card-body">
          <a href="http://localhost/abanico-master/usuario/direcciones" class="disabled">Ver mis direcciones registradas</a>
        </div>
      </div>
      ...
      <div class="card border-warning text-center  mb-3">
        ...
        <div class="card-body">
          <a href="http://localhost/abanico-master/usuario/pass">Cambiar mi contraseña</a>
        </div>
      </div>
      ...
      <div class="card border-danger text-center  mb-3">
        ...
        <div class="card-body">
          <button type="button" id="borrar_perfil" class="btn btn-sm btn-link borrar_entrada" data-enlace="http://localhost/abanico-master/usuario/borrar">Borrar tu cuenta</button>
        </div>
      </div>
