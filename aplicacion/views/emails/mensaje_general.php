                    ...
                    <tr>
                      <td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="head2">
                                  <h2 style="margin:0;color:#495057;"><strong><?php echo $info['Titulo'] ?></strong></h2>
                                  <p style="margin:0;color:#495057;"><?php echo $info['Nombre'] ?></p>
                                </td>
                            </tr>
                          </tbody>
                        </table>
                                  ...
                                  <tr>
                                    <td align="center">
                                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                        <tbody>
                                          <tr>
                                            <td> <a href="<?php echo $info['EnlaceBoton'] ?>" target="_blank"><?php echo $info['TextoBoton'] ?></a> </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </td>
