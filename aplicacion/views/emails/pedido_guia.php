                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="head2" style="font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: 600; text-align: center; border-top: 1px solid lightgray;background-image: url('<?php echo base_url('assets/global/img/pleca_mail.png'); ?>')">
                                  <h2 style="margin:0;color:#495057;"><strong>Tus productos están en camino</strong></h2>
                                  <h3 style="margin:0;color:#495057;">El folio de tu pedido es: #<strong><?php echo $pedido['PEDIDO_FOLIO']; ?></strong></h3>
                                  <hr>
                                  <p>El número de guía para rastrear tu paquete es: <?php echo $pedido_tienda['GUIA_PAQUETERIA']; ?></p>
                                  <p>y puedes rastrearlo en <a href="<?php echo $pedido_tienda['URL_RASTREO']; ?>">este enlace</a></p>
                                </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <tr>
                      <td style="background:#d0d6d8; border:none;text-align:center;">
                        ...
                        <h2 style="text-align:center; color:#495057;">¡Estos productos ya están en camino!</h2>
                      </td>
                    </tr>
                  </table>
